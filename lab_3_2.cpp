...
int main() {
  // เขียนโปรแกรมเพิ่ม เพื่อหาขนาดตัวแปรที่กำหนด
   ...
   cout << "Size of signed unsigned short int : " << sizeof(unsigned short int) << endl;
   cout << "Size of long int : " << sizeof(long int) << endl;
...
cout << "Size of bool : " << sizeof(bool) << endl;
   ...
   cout << "Min of char : " << numeric_limits<char>::min() << endl;
    ...
    cout << "Min of unsigned char : " << numeric_limits<unsigned>::min() << endl;
    cout << "max of unsigned char : " << numeric_limits<unsigned>::max() << endl;
